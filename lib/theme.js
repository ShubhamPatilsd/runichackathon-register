...
const fonts = `'DM Sans', system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', 'Roboto', 'Helvetica Neue', Helvetica, sans-serif`
...
const theme = {
  ...
  fonts: {
    monospace:
      'DM Sans, ui-monospace, "Roboto Mono", Menlo, Consolas, monospace',
    heading: `${fonts}`,
    body: `${fonts}`
  },
  lineHeights: {
