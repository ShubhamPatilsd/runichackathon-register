...
const fonts = `'DM Mono', system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', 'Roboto', 'Helvetica Neue', Helvetica, sans-serif`
...
const theme = {
  ...
  fonts: {
    monospace: 'Inter, ui-monospace, "Roboto Mono", Menlo, Consolas, monospace',
    heading: `${fonts}`,
    body: `${fonts}`
  },
  lineHeights: {
