...
export const manifest = {
  questions: [
    ...
    {
      header: 'Workshops',
      label: `At Runic, attendees will have an opportunity to host their own informal workshops! You bring a passion and we'll provide a room with participants. These questions are not a commitment! You can choose to change your topic or not present at any time.`,
      items: [
        {
          key: 'Would you be interested in hosting a workshop session at Runic?',
        ...
        },
        {
          ...
          check: data =>
            data[
              'Would you be interested in hosting a workshop session at Runic?'
            ] == `No, it's alright.` ||
            data[
              'Would you be interested in hosting a workshop session at Runic?'
            ] === undefined
